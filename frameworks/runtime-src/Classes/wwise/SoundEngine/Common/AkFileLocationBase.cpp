...
{
	LOGAK("CAkFileLocationBase::GetFullFilePath in_pszFileName : %s", in_pszFileName);
    if ( !in_pszFileName )
    {
...
{
	LOGAK("CAkFileLocationBase::SetBasePath");
