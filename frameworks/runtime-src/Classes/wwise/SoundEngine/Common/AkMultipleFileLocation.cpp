...
{
	LOGAK("CAkMultipleFileLocation::AddBasePath");
...
#ifdef AK_ANDROID
	LOGAK("CAkMultipleFileLocation::AddBasePath 222");
	AKRESULT eDirectoryResult = CAkFileHelpers::MyCheckDirectoryExists(in_pszBasePath);
#else
	AKRESULT eDirectoryResult = CAkFileHelpers::CheckDirectoryExists(in_pszBasePath);
#endif
	// end my
